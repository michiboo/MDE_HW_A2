...
/**
 * This is the item provider adapter for a {@link cryptoExchangePackage.Token} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_address_feature", "_UI_Token_type"),
				 CryptoExchangePackagePackage.Literals.TOKEN__ADDRESS,
				 true,
				 false,
				 false,
	...
	protected void addDecimalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_decimal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_decimal_feature", "_UI_Token_type"),
				 CryptoExchangePackagePackage.Literals.TOKEN__DECIMAL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Token Network feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTokenNetworkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_TokenNetwork_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_TokenNetwork_feature", "_UI_Token_type"),
				 CryptoExchangePackagePackage.Literals.TOKEN__TOKEN_NETWORK,
				 true,
				 false,
				 true,
				 null,
