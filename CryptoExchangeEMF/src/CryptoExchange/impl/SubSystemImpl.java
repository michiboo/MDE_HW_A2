 ...
 * </p>
 * <ul>
 *   <li>{@link CryptoExchange.impl.SubSystemImpl#getName <em>Name</em>}</li>
 *   <li>{@link CryptoExchange.impl.SubSystemImpl#getAccounts <em>Accounts</em>}</li>
 *   <li>{@link CryptoExchange.impl.SubSystemImpl#getTokenPairs <em>Token Pairs</em>}</li>
 *   <li>{@link CryptoExchange.impl.SubSystemImpl#getOrders <em>Orders</em>}</li>
 *   <li>{@link CryptoExchange.impl.SubSystemImpl#getSavingOrders <em>Saving Orders</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubSystemImpl extends MinimalEObjectImpl.Container implements SubSystem {
	...
	protected EClass eStaticClass() {
		return CryptoExchangePackage.Literals.SUB_SYSTEM;
	}
	...
	public void setName(SubSystemName newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.SUB_SYSTEM__NAME, oldName, name));
	}
	...
	public EList<Account> getAccounts() {
		if (accounts == null) {
			accounts = new EObjectContainmentEList<Account>(Account.class, this, CryptoExchangePackage.SUB_SYSTEM__ACCOUNTS);
		}
		return accounts;
	}
	...
	public EList<TokenPair> getTokenPairs() {
		if (tokenPairs == null) {
			tokenPairs = new EObjectContainmentEList<TokenPair>(TokenPair.class, this, CryptoExchangePackage.SUB_SYSTEM__TOKEN_PAIRS);
		}
		return tokenPairs;
	}
	...
	public EList<Order> getOrders() {
		if (orders == null) {
			orders = new EObjectResolvingEList<Order>(Order.class, this, CryptoExchangePackage.SUB_SYSTEM__ORDERS);
		}
		return orders;
	}
	...
	public EList<SavingOrder> getSavingOrders() {
		if (savingOrders == null) {
			savingOrders = new EObjectContainmentEList<SavingOrder>(SavingOrder.class, this, CryptoExchangePackage.SUB_SYSTEM__SAVING_ORDERS);
		}
		return savingOrders;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CryptoExchangePackage.SUB_SYSTEM__ACCOUNTS:
				return ((InternalEList<?>)getAccounts()).basicRemove(otherEnd, msgs);
			case CryptoExchangePackage.SUB_SYSTEM__TOKEN_PAIRS:
				return ((InternalEList<?>)getTokenPairs()).basicRemove(otherEnd, msgs);
			case CryptoExchangePackage.SUB_SYSTEM__SAVING_ORDERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CryptoExchangePackage.SUB_SYSTEM__NAME:
				return getName();
			case CryptoExchangePackage.SUB_SYSTEM__ACCOUNTS:
				return getAccounts();
			case CryptoExchangePackage.SUB_SYSTEM__TOKEN_PAIRS:
				return getTokenPairs();
			case CryptoExchangePackage.SUB_SYSTEM__ORDERS:
				return getOrders();
			case CryptoExchangePackage.SUB_SYSTEM__SAVING_ORDERS:
