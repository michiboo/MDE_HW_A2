 ...
 * </p>
 * <ul>
 *   <li>{@link CryptoExchange.impl.SavingOrderImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link CryptoExchange.impl.SavingOrderImpl#getMatureDate <em>Mature Date</em>}</li>
 *   <li>{@link CryptoExchange.impl.SavingOrderImpl#getInterest <em>Interest</em>}</li>
 *   <li>{@link CryptoExchange.impl.SavingOrderImpl#getToken <em>Token</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SavingOrderImpl extends MinimalEObjectImpl.Container implements SavingOrder {
	...
	protected EClass eStaticClass() {
		return CryptoExchangePackage.Literals.SAVING_ORDER;
	}
	...
	public void setAmount(float newAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.SAVING_ORDER__AMOUNT, oldAmount, amount));
	}
	...
	public void setMatureDate(Date newMatureDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.SAVING_ORDER__MATURE_DATE, oldMatureDate, matureDate));
	}
	...
	public void setInterest(double newInterest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.SAVING_ORDER__INTEREST, oldInterest, interest));
	}
	...
	public Token getToken() {
		if (token != null && token.eIsProxy()) {
			...
			if (token != oldToken) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CryptoExchangePackage.SAVING_ORDER__TOKEN, oldToken, token));
			}
		}
		return token;
	}
	...
	public void setToken(Token newToken) {
		...
		token = newToken;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.SAVING_ORDER__TOKEN, oldToken, token));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CryptoExchangePackage.SAVING_ORDER__AMOUNT:
				return getAmount();
			case CryptoExchangePackage.SAVING_ORDER__MATURE_DATE:
				return getMatureDate();
			case CryptoExchangePackage.SAVING_ORDER__INTEREST:
				return getInterest();
			case CryptoExchangePackage.SAVING_ORDER__TOKEN:
