 ...
 * </p>
 * <ul>
 *   <li>{@link CryptoExchange.impl.TokenNetworkImpl#getChainID <em>Chain ID</em>}</li>
 *   <li>{@link CryptoExchange.impl.TokenNetworkImpl#getRPC <em>RPC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokenNetworkImpl extends MinimalEObjectImpl.Container implements TokenNetwork {
	...
	protected EClass eStaticClass() {
		return CryptoExchangePackage.Literals.TOKEN_NETWORK;
	}
	...
	public void setChainID(int newChainID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.TOKEN_NETWORK__CHAIN_ID, oldChainID, chainID));
	}
	...
	public void setRPC(String newRPC) {
		...
		rpc = newRPC;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangePackage.TOKEN_NETWORK__RPC, oldRPC, rpc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CryptoExchangePackage.TOKEN_NETWORK__CHAIN_ID:
				return getChainID();
			case CryptoExchangePackage.TOKEN_NETWORK__RPC:
				return getRPC();
		}
