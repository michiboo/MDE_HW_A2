...
public class CryptoExchangePackageValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Check Account Balance' of 'Order'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int ORDER__CHECK_ACCOUNT_BALANCE = 2;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Check Order Type Constraint' of 'Sub System'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int SUB_SYSTEM__CHECK_ORDER_TYPE_CONSTRAINT = 3;
	...
	public boolean validateOrder(Order order, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOrder_checkAccountBalance(order, diagnostics, context);
		return result;
	}

	/**
	 * Validates the checkAccountBalance constraint of '<em>Order</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateOrder_checkAccountBalance(Order order, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return order.checkAccountBalance(diagnostics, context);
	}
	...
	public boolean validateSubSystem(SubSystem subSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateSubSystem_checkOrderTypeConstraint(subSystem, diagnostics, context);
		return result;
	}

	/**
	 * Validates the checkOrderTypeConstraint constraint of '<em>Sub System</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateSubSystem_checkOrderTypeConstraint(SubSystem subSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return subSystem.checkOrderTypeConstraint(diagnostics, context);
	}
