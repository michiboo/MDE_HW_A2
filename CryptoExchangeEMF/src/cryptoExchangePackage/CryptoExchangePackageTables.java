...
public class CryptoExchangePackageTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ String STR_0x = "0x";
	public static final /*@NonInvalid*/ String STR_Saving = "Saving";
	...
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_Order = TypeId.SET.getSpecializedId(CryptoExchangePackageTables.CLSSid_Order);
	...
	public static class Operations {
		...
		public static final ExecutorOperation _SubSystem__getNextOrderId = new ExecutorOperation("getNextOrderId", TypeUtil.EMPTY_PARAMETER_TYPES, Types._SubSystem,
			0, TemplateParameters.EMPTY_LIST, null);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Account__ID = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ACCOUNT__ID, Types._Account, 0);
		public static final ExecutorProperty _Account__TokensBalance = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ACCOUNT__TOKENS_BALANCE, Types._Account, 1);
		...
		public static final ExecutorProperty _Order__ID = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__ID, Types._Order, 1);
		public static final ExecutorProperty _Order__Price = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__PRICE, Types._Order, 2);
		public static final ExecutorProperty _Order__TokenPair = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__TOKEN_PAIR, Types._Order, 3);
		public static final ExecutorProperty _Order__Type = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__TYPE, Types._Order, 4);
		public static final ExecutorProperty _Order__account = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__ACCOUNT, Types._Order, 5);
		public static final ExecutorProperty _Order__leverage = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.ORDER__LEVERAGE, Types._Order, 6);
		...
		public static final ExecutorProperty _SavingOrder__SubSystem__SavingOrders = new ExecutorPropertyWithImplementation("SubSystem", Types._SavingOrder, 5, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__SAVING_ORDERS));

		public static final ExecutorProperty _SubSystem__Name = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__NAME, Types._SubSystem, 0);
		public static final ExecutorProperty _SubSystem__Orders = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__ORDERS, Types._SubSystem, 1);
		public static final ExecutorProperty _SubSystem__SavingOrders = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__SAVING_ORDERS, Types._SubSystem, 2);
		public static final ExecutorProperty _SubSystem__TokenPairs = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__TOKEN_PAIRS, Types._SubSystem, 3);
		public static final ExecutorProperty _SubSystem__accounts = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__ACCOUNTS, Types._SubSystem, 4);
		...
		public static final ExecutorProperty _TokenBalance__Account__TokensBalance = new ExecutorPropertyWithImplementation("Account", Types._TokenBalance, 2, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.ACCOUNT__TOKENS_BALANCE));
		...
		public static final ExecutorProperty _TokenNetwork__Token__TokenNetwork = new ExecutorPropertyWithImplementation("Token", Types._TokenNetwork, 2, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.TOKEN__TOKEN_NETWORK));
		public static final ExecutorProperty _TokenNetwork__cryptoExchange__TokenNetworks = new ExecutorPropertyWithImplementation("cryptoExchange", Types._TokenNetwork, 3, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.CRYPTO_EXCHANGE__TOKEN_NETWORKS));
		...
		public static final ExecutorProperty _TokenPair__price = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.TOKEN_PAIR__PRICE, Types._TokenPair, 2);
		public static final ExecutorProperty _TokenPair__Order__TokenPair = new ExecutorPropertyWithImplementation("Order", Types._TokenPair, 3, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.ORDER__TOKEN_PAIR));
		public static final ExecutorProperty _TokenPair__SubSystem__TokenPairs = new ExecutorPropertyWithImplementation("SubSystem", Types._TokenPair, 4, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.SUB_SYSTEM__TOKEN_PAIRS));
		...
		public static final ExecutorProperty _TransferRequest__Token = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.TRANSFER_REQUEST__TOKEN, Types._TransferRequest, 1);
		public static final ExecutorProperty _TransferRequest__amount = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.TRANSFER_REQUEST__AMOUNT, Types._TransferRequest, 2);
		public static final ExecutorProperty _TransferRequest__type = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.TRANSFER_REQUEST__TYPE, Types._TransferRequest, 3);
		public static final ExecutorProperty _TransferRequest__Account__transferRequest = new ExecutorPropertyWithImplementation("Account", Types._TransferRequest, 4, new EcoreLibraryOppositeProperty(CryptoExchangePackagePackage.Literals.ACCOUNT__TRANSFER_REQUEST));
		...
		public static final ExecutorProperty _cryptoExchange__Name = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.CRYPTO_EXCHANGE__NAME, Types._cryptoExchange, 2);
		public static final ExecutorProperty _cryptoExchange__SubSystem = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.CRYPTO_EXCHANGE__SUB_SYSTEM, Types._cryptoExchange, 3);
		public static final ExecutorProperty _cryptoExchange__TokenNetworks = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.CRYPTO_EXCHANGE__TOKEN_NETWORKS, Types._cryptoExchange, 4);
		public static final ExecutorProperty _cryptoExchange__Tokens = new EcoreExecutorProperty(CryptoExchangePackagePackage.Literals.CRYPTO_EXCHANGE__TOKENS, Types._cryptoExchange, 5);
		static {
			Init.initEnd();
		}
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SubSystem__SubSystem = {
			CryptoExchangePackageTables.Operations._SubSystem__getNextOrderId /* getNextOrderId() */
		};
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Account = {
			CryptoExchangePackageTables.Properties._Account__ID,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Order = {
			...
			CryptoExchangePackageTables.Properties._Order__ID,
